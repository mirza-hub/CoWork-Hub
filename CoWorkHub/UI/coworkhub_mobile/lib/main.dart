  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => SpaceUnitProvider()),
        ChangeNotifierProvider(create: (_) => SpaceUnitResourcesProvider()),
        ChangeNotifierProvider(create: (_) => SpaceUnitImageProvider()),
